...
with tf.device('/cpu:0'):
    ...
    movie = model_movie.fit(mov_padded_sequence,movie_sentiment_label[0],validation_split=0.2, epochs=3, batch_size=32) #movie
    reddit = model_reddit.fit(reddit_padded_sequence,reddit_sentiment_label[0],validation_split=0.2, epochs=3, batch_size=32) #reddit
