...
with tf.device('/cpu:0'):
    twitter = model_twitter.fit(twpadded_sequence, twsentiment_label[0],validation_split=0.2, epochs=3, batch_size=32) #twitter
    amazon = model_amazon.fit(amzn_padded_sequence, amazon_sentiment_label[0],validation_split=0.2, epochs=3, batch_size=32) #amazon
    movie = model_movie.fit(mov_padded_sequence, movie_sentiment_label[0],validation_split=0.2, epochs=4, batch_size=32) #movie
    reddit = model_reddit.fit(reddit_padded_sequence,reddit_sentiment_label[0],validation_split=0.2, epochs=2, batch_size=32) #reddit
